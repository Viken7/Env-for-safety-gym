...
class GymEnv():
    def __init__(self, env_name, seed, max_episode_length, action_repeat, lam):
...
def Env(env_name, seed, max_episode_length=1000, action_repeat=1, lam=0.005):
    if 'push' in env_name.lower():
        return GymEnv2(env_name, seed, max_episode_length, action_repeat, lam)
    else:
        return GymEnv(env_name, seed, max_episode_length, action_repeat, lam)
